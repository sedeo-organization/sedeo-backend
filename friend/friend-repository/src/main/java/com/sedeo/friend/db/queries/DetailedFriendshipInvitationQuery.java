...
public class DetailedFriendshipInvitationQuery {
    ...
    public static final String FIND_DETAILED_FRIENDSHIP_INVITATIONS = """
            SELECT
                ...
                iu.user_id AS inviting_user_id, iu.first_name AS inviting_first_name, iu.last_name AS inviting_last_name, iu.phone_number AS inviting_phone_number,
                ru.user_id AS invited_user_id, ru.first_name AS invited_first_name, ru.last_name AS invited_last_name, ru.phone_number AS invited_phone_number
            FROM %s fi
